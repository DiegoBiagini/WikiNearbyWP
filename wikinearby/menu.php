...
function wikinearby_menu(){
	...
	<a onclick="return confirm('Are you sure want to delete all locations?');" style="color:red; display:block;" href="<?php echo esc_html(get_admin_url().'admin-post.php?action=delete_all'); ?>">Delete all locations</a>
	<?php
}